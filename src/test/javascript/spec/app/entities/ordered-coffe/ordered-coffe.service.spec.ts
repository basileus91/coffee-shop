...
describe('Service Tests', () => {
  describe('OrderedCoffe Service', () => {
    let injector: TestBed;
    let service: OrderedCoffeService;
    let httpMock: HttpTestingController;
    let elemDefault: IOrderedCoffe;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a OrderedCoffe', async () => {
      ...
      it('should update a OrderedCoffe', async () => {
        const returnedFromService = Object.assign(
          {
            coffe: 'BBBBBB',
            client: 'BBBBBB',
      ...
      it('should return a list of OrderedCoffe', async () => {
        const returnedFromService = Object.assign(
          {
            coffe: 'BBBBBB',
            client: 'BBBBBB',
      ...
      it('should delete a OrderedCoffe', async () => {
