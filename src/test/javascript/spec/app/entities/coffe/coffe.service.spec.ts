...
describe('Service Tests', () => {
  describe('Coffe Service', () => {
    let injector: TestBed;
    let service: CoffeService;
    let httpMock: HttpTestingController;
    let elemDefault: ICoffe;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(CoffeService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Coffe(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, 0, 'image/png', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Coffe', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            countryName: 'BBBBBB',
