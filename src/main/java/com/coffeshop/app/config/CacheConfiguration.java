package com.coffeshop.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.coffeshop.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.coffeshop.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
